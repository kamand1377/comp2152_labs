...
#  COMP2152 — Kamand Rostami 101586296
# ============================================================
#
...
class Report:
    ...
    def get_by_severity(self, severity):
        # Filter findings where the severity matches the parameter 
    ...
    def summary(self):
        ...
        med_count = len(self.get_by_severity("MEDIUM"))
        ...
        # Iterate and print each finding object 
